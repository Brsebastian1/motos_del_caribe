...
public class NotificationController {
    ...
    @Operation(summary = "Find contracts next to pay", description = "Obtiene una lista de contratos que están próximos a pagar")
    public ResponseEntity<List<ContractDto>> findContractsNextToPay() {
        try {
            ...
            log.error("Error fetching contracts next to pay", e);
